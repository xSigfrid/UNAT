    ...
    <div class="page">
      ...
      <section class="bg-gray-7">
        <div class="breadcrumbs-custom box-transform-wrap context-dark bg-image gradient-overlay" style="background-image: url(images/bg-typography.jpg);">
          <div class="container">
            <h3 class="breadcrumbs-custom-title">Comision Organizadora Universidad Nacional Autonoma de Tayacaja Daniel Hernandez Morillo</h3>
          ...
          <div class="row row-60 flex-lg-row-reverse">
            <div class="col-lg-6 col-xl-7">
              <div class="slick-project">
                ...
                <div class="slick-slider carousel-parent" data-arrows="true" data-autoplay="true" data-swipe="true" data-items="1" data-child="#child-carousel-7" data-for="#child-carousel-7" data-slide-effect="true">
                  <div class="item"><img src="images\vpa\vpa1.png" alt="" width="670" height="477"/>
                    <div class="slick-project-caption">
                      <div class="slick-project-title">Photo #1</div>
                    </div>
                  </div>
                  <div class="item"><img src="images\vpa\vpa2.jpg" alt="" width="670" height="477"/>
                    <div class="slick-project-caption">
                      <div class="slick-project-title">Photo #2</div>
                    </div>
                  </div>
                  <div class="item"><img src="images\vpa\vpa3.png" alt="" width="670" height="477"/>
                    <div class="slick-project-caption">
                      <div class="slick-project-title">Photo #3</div>
                    </div>
                  </div>
                  <div class="item"><img src="images\vpa\vpa4.png" alt="" width="670" height="477"/>
                    <div class="slick-project-caption">
            ...
            <div class="col-lg-6 col-xl-5">
              <div class="project-page">
                ...
                </div><a class="button button-lg button-primary-gradient button-winona" href="https://vpa.unat.edu.pe/">Pagina VPA</a>
              </div>
            </div>
          </div>
        </div>
