          ...
          <div class="row row-60">
            <div class="col-md-7 col-xl-8">
              <div class="single-service"><img src="images/single-service-1-770x426.jpg" alt="" width="770" height="426"/>
                <h4>INGENIERIA INDUSTRIAS ALIMENTARIAS</h4>
                <p>Ingenieria Industrias Alimentarias: La Ingeniería Industrial es una carrera que se enfoca en el diseño y gestión de las operaciones empresariales para garantizar su funcionamiento óptimo.</p>
                    ...
                    <div class="card-group-custom card-group-corporate" id="accordion3" role="tablist" aria-multiselectable="false">
                      ...
                      <article class="card card-custom card-corporate">
                        ...
                        <div class="collapse" id="accordion3Collapse2" role="tabpanel" aria-labelledby="accordion3Heading2" data-bs-parent="#accordion3">
                          <div class="card-body">
                          <p>Asimila la estructura conceptual del Ingeniero en Industrias Alimentarias, su objeto de estudio, campo de acción y áreas para desarrollarse integral y profesionalmente como tal.</p>
                            <p>Comprende los conocimientos reales necesarios y pertinentes del campo del Ingeniero en Industrias Alimentarias, tales como: manejo y conservación pos cosecha de materias primas alimentarias, transformación de alimentos empacado y embalaje de alimentos.</p>
